...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [AiGridwork](https://github.com/AiGridwork) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for AiGridwork.
...
```bash
git clone https://github.com/AiGridwork/core
cd core
go mod download
```
